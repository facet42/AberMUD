...
extern uintptr_t PairArg(unsigned short *);
...
extern size_t ReadRecord(FILE *,UFF *);
...
extern struct ParserContext ParserData[];
extern short ParsingPersona;

extern void SetPersona(int);
extern struct ParserContext *GetContext(short);
...
extern int FindUserFD(unsigned int);
extern int IsUserFD(unsigned int);
...
extern int MakeConnection(unsigned int, COMTEXT *);
